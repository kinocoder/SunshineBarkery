            ...
            <div class="col-xxl-4 col-xl-5 col-lg-6 col-sm-8 mx-auto">
                <div class="log-in-box">
                    <div class="log-in-title">
                        <h3>Welcome To Sunshine Bakery</h3>
                    ...
                    <div class="input-box">
                        ...
                        <form class="row g-4" method="post" action="<%= request.getContextPath() %>/register" onsubmit="return validateForm();">
                            <div class="col-12">
...
<script>
    function validateForm() {
        ...
        if (!phoneRegex.test(phone)) {
            alert("Số điện thoại không hợp lệ! Vui lòng nhập 10-12 số.");
            return false;
        }
        ...
        // Kiểm tra điều khoản đã được chấp nhận chưa
        if (!terms) {
