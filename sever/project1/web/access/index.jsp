...
<body>
            ...
            <div class="header-wrapper m-0">
                <div class="header-logo-wrapper p-0">
                    <div class="logo-wrapper">
                        <a href="index.html">
                            <img class="img-fluid main-logo" src="backendAssets/images/logo/1.png" alt="logo">
                            <img class="img-fluid white-logo" src="backendAssets/images/logo/1-white.png" alt="logo">
                        </a>
                    </div>
                    <div class="toggle-sidebar">
                        <i class="status_toggle middle sidebar-toggle" data-feather="align-center"></i>
                        <a href="index.html">
                            <img src="backendAssets/images/logo/1.png" class="img-fluid" alt="">
                        </a>
                    </div>
                </div>
                    ...
                    <ul class="nav-menus">
                        ...
                        <li class="profile-nav onhover-dropdown pe-0 me-0">
                            <div class="media profile-media">
                                <img class="user-profile rounded-circle" src="backendAssets/images/users/4.jpg" alt="">
                ...
                <div>
                    <div class="logo-wrapper logo-wrapper-center">
                        <a href="index.html" data-bs-original-title="" title="">
                            <img class="img-fluid for-white" src="backendAssets/images/logo/full-white.png" alt="logo">
                        </a>
                        <div class="back-btn">
                    ...
                    <div class="logo-icon-wrapper">
                        <a href="index.html">
                            <img class="img-fluid main-logo main-white" src="backendAssets/images/logo/logo.png" alt="logo">
                            <img class="img-fluid main-logo main-dark" src="backendAssets/images/logo/logo-white.png"
                                alt="logo">
                        </a>
                    </div>
                                ...
                                <div class="card-body p-0">
                                    <div class="category-slider no-arrow">
                                        <div>
                                            <div class="dashboard-category">
                                                <a href="javascript:void(0)" class="category-image">
                                                    <img src="backendAssets/svg/vegetable.svg" class="img-fluid" alt="">
                                                </a>
                                        ...
                                        <div>
                                            <div class="dashboard-category">
                                                <a href="javascript:void(0)" class="category-image">
                                                    <img src="backendAssets/svg/cup.svg" class="img-fluid" alt="">
                                                </a>
                                                <a href="javascript:void(0)" class="category-name">
                                                    <h6>Beverages</h6>
                                                </a>
                                        ...
                                        <div>
                                            <div class="dashboard-category">
                                                <a href="javascript:void(0)" class="category-image">
                                                    <img src="backendAssets/svg/meats.svg" class="img-fluid" alt="">
                                                </a>
                                                <a href="javascript:void(0)" class="category-name">
                                                    <h6>Meats & Seafood</h6>
                                                </a>
                                        ...
                                        <div>
                                            <div class="dashboard-category">
                                                <a href="javascript:void(0)" class="category-image">
                                                    <img src="backendAssets/svg/breakfast.svg" class="img-fluid" alt="">
                                                </a>
                                                <a href="javascript:void(0)" class="category-name">
                                                    <h6>Breakfast</h6>
                                                </a>
                                        ...
                                        <div>
                                            <div class="dashboard-category">
                                                <a href="javascript:void(0)" class="category-image">
                                                    <img src="backendAssets/svg/frozen.svg" class="img-fluid" alt="">
                                                </a>
                                                <a href="javascript:void(0)" class="category-name">
                                                    <h6>Frozen Foods</h6>
                                                </a>
                                        ...
                                        <div>
                                            <div class="dashboard-category">
                                                <a href="javascript:void(0)" class="category-image">
                                                    <img src="backendAssets/svg/milk.svg" class="img-fluid" alt="">
                                                </a>
                                                <a href="javascript:void(0)" class="category-name">
                                                    <h6>Milk & Dairies</h6>
                                                </a>
                                        ...
                                        <div>
                                            <div class="dashboard-category">
                                                <a href="javascript:void(0)" class="category-image">
                                                    <img src="backendAssets/svg/pet.svg" class="img-fluid" alt="">
                                                </a>
                                                <a href="javascript:void(0)" class="category-name">
                                                    <h6>Pet Food</h6>
                                                </a>
                                                ...
                                                <tbody>
                                                        ...
                                                        <td>
                                                            <div class="best-product-box">
                                                                <div class="product-image">
                                                                    <img src="backendAssets/images/product/1.png"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="best-product-box">
                                                                <div class="product-image">
                                                                    <img src="backendAssets/images/product/2.png"
                                                                        class="img-fluid" alt="Product">
                                                                </div>
                                                                <div class="product-name">
                                                                    <h5>Aata Buscuit</h5>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="best-product-box">
                                                                <div class="product-image">
                                                                    <img src="backendAssets/images/product/3.png"
                                                                        class="img-fluid" alt="Product">
                                                                </div>
                                                                <div class="product-name">
                                                                    <h5>Aata Buscuit</h5>
    ...
    <!-- latest js -->
    <script src="backendAssets/js/jquery-3.6.0.min.js"></script>

    <!-- Bootstrap js -->
    <script src="backendAssets/js/bootstrap/bootstrap.bundle.min.js"></script>

    <!-- feather icon js -->
    <script src="backendAssets/js/icons/feather-icon/feather.min.js"></script>
    <script src="backendAssets/js/icons/feather-icon/feather-icon.js"></script>

    <!-- scrollbar simplebar js -->
    <script src="backendAssets/js/scrollbar/simplebar.js"></script>
    <script src="backendAssets/js/scrollbar/custom.js"></script>

    <!-- Sidebar jquery -->
    <script src="backendAssets/js/config.js"></script>

    <!-- tooltip init js -->
    <script src="backendAssets/js/tooltip-init.js"></script>

    <!-- Plugins JS -->
    <script src="backendAssets/js/sidebar-menu.js"></script>
    <script src="backendAssets/js/notify/bootstrap-notify.min.js"></script>
    <script src="backendAssets/js/notify/index.js"></script>

    <!-- Apexchar js -->
    <script src="backendAssets/js/chart/apex-chart/apex-chart1.js"></script>
    <script src="backendAssets/js/chart/apex-chart/moment.min.js"></script>
    <script src="backendAssets/js/chart/apex-chart/apex-chart.js"></script>
    <script src="backendAssets/js/chart/apex-chart/stock-prices.js"></script>
    <script src="backendAssets/js/chart/apex-chart/chart-custom1.js"></script>


    <!-- slick slider js -->
    <script src="backendAssets/js/slick.min.js"></script>
    <script src="backendAssets/js/custom-slick.js"></script>

    <!-- customizer js -->
    <script src="backendAssets/js/customizer.js"></script>

    <!-- ratio js -->
    <script src="backendAssets/js/ratio.js"></script>

    <!-- sidebar effect -->
    <script src="backendAssets/js/sidebareffect.js"></script>

    <!-- Theme js -->
    <script src="backendAssets/js/script.js"></script>
</body>
